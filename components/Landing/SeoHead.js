...
const defaultMeta = {
    title: "LaslesVPN",
    siteName: "LaslesVPN",
    description: "Landing page VPN LaslesVPN Best VPN For Privacy, Country and Cheapest", // change base url of your web (without "/" at the end)
    url: "https://next-landing-vpn.vercel.app",
    type: "website",
    robots: "follow, index", // change with url of your image (recommended dimension = 1.91:1)
...
const SeoHead = (props) => {
    ...
    return (<Head>
        ...
        {/* Favicons */}
        {favicons.map((linkProps) => (<link key={linkProps.href} {...linkProps} />))}
        {/* Windows 8 app icon */}
